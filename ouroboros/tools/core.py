...
def _summarize_dialogue(ctx: ToolContext, last_n: int = 200) -> str:
    ...
    try:
        ...
        for entry in entries:
            ...
            role = "Creator" if direction == "in" else "Jo"
            text = entry.get("text", "")
        ...
        prompt = f"""Summarize the following dialogue history between the creator and Jo.
...
def get_tools() -> List[ToolEntry]:
    return [
        ...
        ToolEntry(
            ...
            {
                "name": "drive_list",
                "description": "List files under a storage directory.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "dir": {"type": "string", "default": "."},
        ...
        ToolEntry(
            ...
            {
                "name": "drive_write",
                "description": "Write a UTF-8 text file to local storage.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "path": {"type": "string"},
