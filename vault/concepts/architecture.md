...
Background presence via [[background_consciousness]]
Code intelligence via [[code_intelligence]]
Runtime managed by [[supervisor_layer]]
System architecture implements all BIBLE principles [[principle_0__agency]]
System architecture implements all BIBLE principles [[principle_1__continuity]]
System architecture implements all BIBLE principles [[principle_2__self-creation]]
System architecture implements all BIBLE principles [[principle_3__llm-first]]
System architecture implements all BIBLE principles [[principle_4__authenticity]]
System architecture implements all BIBLE principles [[principle_5__minimalis]]
System architecture implements all BIBLE principles [[principle_6__becoming]]
System architecture implements all BIBLE principles [[principle_7__versioning]]
